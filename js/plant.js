...
const BASE_SPECIES = [
  ...
  // ===== TREES (7) =====
  { id: 'cherry_blossom', name: 'Cherry Blossom', emoji: '🌸', image: 'assets/plants/cherry_blossom.png', masteryImage: 'assets/mastery/Cherry blossom.png', category: 'Trees', style: 'tree', petalCount: 5, petalLength: 18, hasFace: false, defaultCenter: '#ff69b4', defaultStem: '#5d4037', defaultLeaf: '#4caf50', 
    facts: {
  ...
  { id: 'olive', name: 'Olive Tree', emoji: '🫒', image: 'assets/plants/olive_tree.png', masteryImage: 'assets/mastery/Olive.png', category: 'Trees', style: 'tree', petalCount: 0, petalLength: 0, hasFace: false, defaultCenter: '#827717', defaultStem: '#5d4037', defaultLeaf: '#9e9d24', 
    facts: {
  ...
  { id: 'aloe_vera', name: 'Aloe Vera', emoji: '🌿', image: 'assets/plants/aloe_vera.png', masteryImage: 'assets/mastery/Aloe vera.png', category: 'Succulents', style: 'succulent', petalCount: 10, petalLength: 22, hasFace: false, defaultCenter: '#4caf50', defaultStem: '#388e3c', defaultLeaf: '#66bb6a', 
    facts: {
  ...
  { id: 'jade_plant', name: 'Jade Plant', emoji: '💚', image: 'assets/plants/jade_plant.png', masteryImage: 'assets/mastery/Jade.png', category: 'Succulents', style: 'succulent', petalCount: 6, petalLength: 18, hasFace: false, defaultCenter: '#2e7d32', defaultStem: '#5d4037', defaultLeaf: '#43a047', 
    facts: {
  ...
  { id: 'corpse_flower', name: 'Corpse Flower', emoji: '🌺', image: 'assets/plants/corpse_flower.png', masteryImage: 'assets/mastery/Corpse flower.png', category: 'Exotic', style: 'flower', petalCount: 1, petalLength: 40, hasFace: false, defaultCenter: '#880e4f', defaultStem: '#388e3c', defaultLeaf: '#4caf50', 
    facts: {
  ...
  { id: 'pitcher_plant', name: 'Pitcher Plant', emoji: '🪴', image: 'assets/plants/pitcher_plant.png', masteryImage: 'assets/mastery/Pitcher plant.png', category: 'Exotic', style: 'carnivorous', petalCount: 3, petalLength: 25, hasFace: false, defaultCenter: '#8bc34a', defaultStem: '#33691e', defaultLeaf: '#689f38', 
    facts: {
  ...
  { id: 'bird_of_paradise', name: 'Bird of Paradise', emoji: '🧡', image: 'assets/plants/bird_of_paradise.png', masteryImage: 'assets/mastery/Bird of paradise.png', category: 'Exotic', style: 'flower', petalCount: 5, petalLength: 35, hasFace: false, defaultCenter: '#e65100', defaultStem: '#2e7d32', defaultLeaf: '#388e3c', 
    facts: {
  ...
  { id: 'dragon_fruit', name: 'Dragon Fruit Cactus', emoji: '🐉', image: 'assets/plants/dragon_fruit.png', masteryImage: 'assets/mastery/Dragon fruit.png', category: 'Exotic', style: 'cactus', petalCount: 8, petalLength: 20, hasFace: false, defaultCenter: '#e91e63', defaultStem: '#2e7d32', defaultLeaf: '#388e3c', 
    facts: {
