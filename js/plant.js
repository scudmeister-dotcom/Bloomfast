...
const BASE_SPECIES = [
  ...
  { id: 'rosemary', name: 'Rosemary', emoji: '🌿', image: 'assets/plants/rosemary.svg', category: 'Herbs', style: 'spike', petalCount: 16, petalLength: 7, hasFace: false, defaultCenter: '#5c6bc0', defaultStem: '#33691e', defaultLeaf: '#558b2f', funFact: 'Rosemary is linked to memory improvement. Ancient Greek students wore garlands of it during exams.' },
  { id: 'mint', name: 'Mint', emoji: '🌱', image: 'assets/plants/mint.svg', category: 'Herbs', style: 'spike', petalCount: 10, petalLength: 6, hasFace: false, defaultCenter: '#66bb6a', defaultStem: '#388e3c', defaultLeaf: '#81c784', funFact: 'Mint is one of the most invasive herbs — it can take over an entire garden in a single season.' },
  { id: 'sage', name: 'Sage', emoji: '🍃', image: 'assets/plants/sage.svg', category: 'Herbs', style: 'spike', petalCount: 14, petalLength: 7, hasFace: false, defaultCenter: '#78909c', defaultStem: '#546e7a', defaultLeaf: '#78909c', funFact: 'The name "sage" comes from the Latin "salvare," meaning "to save," reflecting its medicinal history.' },
  { id: 'thyme', name: 'Thyme', emoji: '🌱', image: 'assets/plants/thyme.svg', category: 'Herbs', style: 'spike', petalCount: 18, petalLength: 5, hasFace: false, defaultCenter: '#c5e1a5', defaultStem: '#558b2f', defaultLeaf: '#7cb342', funFact: 'Ancient Egyptians used thyme for embalming, and Greek soldiers bathed in it for courage.' },
  ...
  { id: 'corpse_flower', name: 'Corpse Flower', emoji: '🌺', image: 'assets/plants/corpse_flower.svg', category: 'Exotic', style: 'flower', petalCount: 1, petalLength: 40, hasFace: false, defaultCenter: '#880e4f', defaultStem: '#388e3c', defaultLeaf: '#4caf50', funFact: 'The corpse flower blooms for only 24-48 hours and smells like rotting flesh to attract pollinators.' },
  { id: 'pitcher_plant', name: 'Pitcher Plant', emoji: '🪴', image: 'assets/plants/pitcher_plant.svg', category: 'Exotic', style: 'carnivorous', petalCount: 3, petalLength: 25, hasFace: false, defaultCenter: '#8bc34a', defaultStem: '#33691e', defaultLeaf: '#689f38', funFact: 'Pitcher plants drown insects in pools of digestive enzymes inside their tubular leaves.' },
  { id: 'bird_of_paradise', name: 'Bird of Paradise', emoji: '🧡', image: 'assets/plants/bird_of_paradise.svg', category: 'Exotic', style: 'flower', petalCount: 5, petalLength: 35, hasFace: false, defaultCenter: '#e65100', defaultStem: '#2e7d32', defaultLeaf: '#388e3c', funFact: 'Bird of Paradise flowers resemble tropical birds in flight and are pollinated by sunbirds.' },
  { id: 'dragon_fruit', name: 'Dragon Fruit Cactus', emoji: '🐉', image: 'assets/plants/dragon_fruit.svg', category: 'Exotic', style: 'cactus', petalCount: 8, petalLength: 20, hasFace: false, defaultCenter: '#e91e63', defaultStem: '#2e7d32', defaultLeaf: '#388e3c', funFact: 'Dragon fruit cactus blooms only at night, earning it the nickname "moonflower."' },
  { id: 'baobab', name: 'Baobab', emoji: '🌳', image: 'assets/plants/baobab.svg', category: 'Exotic', style: 'tree', petalCount: 0, petalLength: 0, hasFace: false, defaultCenter: '#8d6e63', defaultStem: '#6d4c41', defaultLeaf: '#a5d6a7', funFact: 'Baobab trees can store up to 32,000 gallons of water in their trunks to survive droughts.' },
];
